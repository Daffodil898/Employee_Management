...
class Add_Employee implements ActionListener{
    ...
    Add_Employee(){
        ...
        id15.setLayout(null);
        //ImageIcon img = new ImageIcon(ClassLoader.getSystemResource("110-fire-employee-mental-health jpg.jpg"));
       ImageIcon img=new ImageIcon(getClass().getResource("employe.jpg"));
        id15.setIcon(img);
