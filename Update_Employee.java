...
class Update_Employee extends Add_Employee implements ActionListener{
    ...
    Update_Employee(String idaa){
        ...
        id8.setForeground(Color.DARK_GRAY);
        id15.add(id8);
        f.add(id15);
        ...
        b.setBounds(250,400,120,40);
        b.addActionListener(this);
        id15.add(b);

        b1=new JButton("Cancel");
        b1.setBounds(450,400,120,40);
    ...
    void showData(String s){
        try{
            Conn con = new Conn();
            String str = "select * from employee where k= '"+s+"'";
    ...
    public void actionPerformed(ActionEvent ae){
        if(ae.getSource()==b && i==1){
            try{
                Conn con = new Conn();
               // String str = "UPDATE employee set a='"+t1.getText()+"' WHERE k='"+t9.getText()+"";
                String str = "update employee set a='"+t1.getText()+"',bb='"+t2.getText()+"',e='"+t3.getText()+"',ff='"+t4.getText()+"',g='"+t5.getText()+"',h='"+t6.getText()+"',i='"+t7.getText()+"',j='"+t8.getText()+"' where k= '"+id_of_emp+"'";
                
                //System.out.println(t1.getText()+"   "+ t2.getText()+"  "+ t3.getText()+"  "+t4.getText()+"  "+t5.getText()+" "+t6.getText()+"  "+t7.getText()+" "+t8.getText()+" "+t9.getText()+" "+id_of_emp+ "come");
